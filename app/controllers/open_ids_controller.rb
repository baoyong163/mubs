...
class OpenIdsController < ApplicationController
  ...
  before_filter :ensure_valid_checkid_request, :except => [:index, :cancel, :seatbelt_config, :seatbelt_login_state, :show, :new, :create, :edit, :update, :destroy]
  ...
  # and the PAPE (OpenID Provider Authentication Policy Extension) requirements 
